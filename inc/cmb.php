<?php
add_filter( 'cmb_meta_boxes', 'cmb_wobblex_slides_metaboxes' );

function cmb_wobblex_slides_metaboxes( array $meta_boxes ) {
 ...
 // 		array( 'id' => 'field-3', 'name' => 'Repeatable text input field', 'type' => 'text', 'desc' => 'Add up to 5 fields.', 'repeatable' => true, 'repeatable_max' => 5, 'sortable' => true ),
	...
	$fields = array(
		array( 'id' => 'image_field', 'name' => 'Image upload field', 'type' => 'image', 'repeatable' => false, 'show_size' => false ),
		array( 'id' => 'content_field',  'name' => 'WYSIWYG field', 'type' => 'wysiwyg', 'options' => array( 'editor_height' => '100' ), 'repeatable' => false, 'sortable' => false ),
